...
<body>
    <nav class="site-header sticky-top py-1 navbar-track-scroll">
    ...
    <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
      <div class="col-md-5 p-lg-5 mx-auto my-5">
        ...
        <a class="btn btn-outline-secondary user-track" data-eventname="go_home_button_click" href="<?= base_url() ?>">Go to Home</a>
      </div>
